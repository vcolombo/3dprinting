...
; NOTE: These M104 temperatures must EXACTLY match the M109 temperatures below (lines 161-214)
; Any change to a standby temperature must be updated in BOTH locations for correct operation
...
; NOTE: These M109 temperatures must EXACTLY match the M104 temperatures above (lines 104-157)
; M104 starts heating (non-blocking), M109 waits for temperature (blocking)
