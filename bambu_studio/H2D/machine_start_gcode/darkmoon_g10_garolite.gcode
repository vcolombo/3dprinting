...
;   1. M104 commands (lines 104-156) - Initial nozzle heating
;   2. M109 commands (lines 161-213) - Wait for nozzle temp
;   3. G383 commands (lines 458-510) - Z offset calibration temp
;
...
; STANDBY TEMPERATURE CONFIGURATION - SECTION 2 OF 3 (see lines 102-117 for reference)
{if filament_type[initial_no_support_extruder]=="PLA"}
...
;===== z ofst cali start =====
    ...
    ; STANDBY TEMPERATURE CONFIGURATION - SECTION 3 OF 3 (see lines 102-117 for reference)
