...
; NOTE: Temperature values here must match the M109 wait commands below (lines 165-218)
; M104 sets target temperature (non-blocking), M109 waits for it (blocking)
...
; NOTE: Temperature values here must match the M104 set commands above (lines 106-159)
; M109 waits for the temperature set by M104 to be reached
